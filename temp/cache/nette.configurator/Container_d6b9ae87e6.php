<?php
// source: C:\xampp\htdocs\leschka_zadani4/config/common.neon
// source: C:\xampp\htdocs\leschka_zadani4/config/services.neon
// source: array
...
class Container_d6b9ae87e6 extends Nette\DI\Container
{
	...
	public function createService02(): App\Models\User\UserModel
	{
		return new App\Models\User\UserModel($this->getService('database.default.explorer'), $this->getService('security.passwords'));
	}


	public function createService03(): App\Models\Kraj\KrajModel
	{
		return new App\Models\Kraj\KrajModel($this->getService('database.default.explorer'), $this->getService('security.passwords'));
	}


	public function createService04(): App\Models\Obec\ObecModel
	{
		return new App\Models\Obec\ObecModel($this->getService('database.default.explorer'), $this->getService('security.passwords'));
	}
	...
	public function createServiceApplication__3(): App\UI\Home\HomePresenter
	{
		...
		$service->userModel = $this->getService('02');
		$service->obecModel = $this->getService('04');
		$service->krajModel = $this->getService('03');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\leschka_zadani4/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\leschka_zadani4/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\leschka_zadani4/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=seznam_obci', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_d6b9ae87e6 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\leschka_zadani4/temp/cache/latte');
